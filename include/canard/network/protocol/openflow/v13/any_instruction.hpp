...
namespace v13 {
    ...
    using any_instruction = boost::type_erasure::any<
        boost::mpl::vector<
              boost::type_erasure::typeid_<>
            , boost::type_erasure::copy_constructible<>
            , has_type<ofp_instruction_type(), boost::type_erasure::_self const>
            ...
            , has_instruction_order<std::uint64_t(boost::type_erasure::_self const&)>
        >
    >;
