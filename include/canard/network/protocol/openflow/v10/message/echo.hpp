#ifndef CANARD_NETWORK_OPENFLOW_V10_MESSAGES_ECHO_HPP
#define CANARD_NETWORK_OPENFLOW_V10_MESSAGES_ECHO_HPP
        ...
        public:
                ...
                -> T
            {
                ...
                auto const data_length
                    = header.length - sizeof(v10_detail::ofp_header);
                auto data = data_type{
...
#endif // CANARD_NETWORK_OPENFLOW_V10_MESSAGES_ECHO_HPP
