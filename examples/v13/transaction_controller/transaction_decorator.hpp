...
namespace decorators {
  ...
  template <>
  struct message_traits<ofp::v13::messages::echo_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::echo_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::features_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::features_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::get_config_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::get_config_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::queue_get_config_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::queue_get_config_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::barrier_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::barrier_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::role_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::role_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::get_async_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::get_async_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::echo_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::echo_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::features_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::features_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::get_config_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::get_config_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::queue_get_config_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::queue_get_config_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::barrier_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::barrier_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::role_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::role_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::get_async_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::get_async_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::description_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::multipart::description_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::flow_stats_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::multipart::flow_stats_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::aggregate_stats_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::multipart::aggregate_stats_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::table_stats_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::multipart::table_stats_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::port_stats_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::multipart::port_stats_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::queue_stats_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::multipart::queue_stats_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::table_features_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::multipart::table_features_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::port_description_request>
  {
    static constexpr message_kind kind = message_kind::request;
    using reply_type = ofp::v13::messages::multipart::port_description_reply;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::description_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::multipart::description_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::flow_stats_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::multipart::flow_stats_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::aggregate_stats_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::multipart::aggregate_stats_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::table_stats_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::multipart::table_stats_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::port_stats_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::multipart::port_stats_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::queue_stats_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::multipart::queue_stats_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::table_features_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::multipart::table_features_request;
  };
  template <>
  struct message_traits<ofp::v13::messages::multipart::port_description_reply>
  {
    static constexpr message_kind kind = message_kind::reply;
    using request_type = ofp::v13::messages::multipart::port_description_request;
  };

  namespace transaction_decorator_detail {

    using error_msg = ofp::v13::messages::error;
    ...
    using message_kind_t = typename std::conditional<
      ...
      , typename std::conditional<
          T::type() == error_msg::type(), is_error, is_other
        >::type
    >::type;
    ...
    constexpr auto to_key(
        ...
        , std::uint16_t const multipart_type
        , std::uint32_t const xid) noexcept
      -> std::uint64_t
    {
      return std::uint64_t{msg_type} << 48
           | std::uint64_t{multipart_type} << 32
           | std::uint64_t{xid};
    }

    template <
        class T
      , bool = (T::type() == ofp::v13::protocol::OFPT_MULTIPART_REQUEST
             || T::type() == ofp::v13::protocol::OFPT_MULTIPART_REPLY)
    >
    struct multipart_type_if_any
    {
      static constexpr std::uint16_t value = 0;
    };

    template <class T>
    struct multipart_type_if_any<T, true>
    {
      static constexpr std::uint16_t value = T::multipart_type();
    };

    inline static auto get_multipart_type(error_msg const& error)
      -> std::uint16_t
    {
      ofp::v13::protocol::ofp_multipart_request multipart_request;
      std::memcpy(
          &multipart_request, error.data().data(), sizeof(multipart_request));
      boost::endian::big_to_native_inplace(multipart_request);
      return multipart_request.type;
    }
    ...
    struct transaction_base
    {
      ...
      timer_type timer;
      message_base<error_msg>* msg_ptr;
    ...
    struct message_type
    {
      using type = message<void, error_msg>;
    };

    template <class T>
    struct message_type<T, message_kind::request>
    {
      using type = message<typename message_traits<T>::reply_type, error_msg>;
    };
  ...
  private:
      ...
      -> transaction_ptr<Request>
    {
      auto const key = transaction_decorator_detail::to_key(
          Request::type()
        , transaction_decorator_detail::multipart_type_if_any<Request>::value
        , request.xid());
    ...
    {
      {
        ...
        auto const it = data.map.find(
            transaction_decorator_detail::to_key(msg_type, multipart_type, xid));
        if (it == data.map.end()) {
          return {};
        }
    ...
    {
      using request_type = typename message_traits<Reply>::request_type;
      constexpr auto multipart_type
        = transaction_decorator_detail::multipart_type_if_any<request_type>::value;
      return extract_transaction(
            channel->template get_data<transaction_decorator>()
          , request_type::type(), multipart_type, reply.xid());
    }
      ...
      -> transaction_base_ptr
    {
      ...
      if (data_length < sizeof(ofp::v13::protocol::ofp_header)) {
        return {};
      }

      auto const request_header = error.failed_request_header();
      auto multipart_type = std::uint16_t{0};
      if (request_header.type == ofp::v13::protocol::msg_type::multipart_request) {
        if (data_length < sizeof(ofp::v13::protocol::ofp_multipart_request)) {
          return {};
        }
        multipart_type = transaction_decorator_detail::get_multipart_type(error);
      }

      return extract_transaction(
            channel->template get_data<transaction_decorator>()
          , request_header.type, multipart_type, request_header.xid);
    }
  };
