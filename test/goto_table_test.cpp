...
#define BOOST_TEST_MODULE goto_table_test
#else
...
BOOST_AUTO_TEST_CASE(constructor_test)
{
    ...
    BOOST_CHECK_EQUAL(sut.type(), OFPIT_GOTO_TABLE);
...
{
    auto sut = instructions::goto_table{OFPTT_MAX};
...
{
    BOOST_CHECK_THROW(instructions::goto_table{OFPTT_MAX + 1}, int);
}
