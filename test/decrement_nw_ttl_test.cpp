...
#define BOOST_TEST_MODULE decrement_nw_ttl_test
#else
...
BOOST_AUTO_TEST_CASE(constructor_test)
{
    ...
    BOOST_CHECK_EQUAL(sut.type(), OFPAT_DEC_NW_TTL);
...
{
    auto sut = actions::decrement_nw_ttl{};
...
BOOST_AUTO_TEST_CASE(encode_decode_test)
{
    ...
    auto const decoded_action = actions::decrement_nw_ttl::decode(it, buffer.end());
