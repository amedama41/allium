...
BOOST_AUTO_TEST_CASE(constructor_test)
{
    ...
    BOOST_CHECK_EQUAL(sut.type(), protocol::OFPAT_SET_NW_TTL);
...
BOOST_AUTO_TEST_CASE(encode_decode_test)
{
    ...
    auto const sut = actions::set_nw_ttl{1};
    ...
    auto const decoded_action = actions::set_nw_ttl::decode(it, buffer.end());
